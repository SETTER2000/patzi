...
module.exports.uploads = {
  ...
  * * Парусные приложения загружаются и загружаются в файловую систему локального диска по умолчанию, *
      * используя встроенный адаптер файловой системы под названием `Skipper-disk`. Эта особенность  *
      * в основном предназначен для удобства при разработке, так как, в *
