module.exports = {
  ...
  fn: async function (inputs) {
    ...
    let dt = JSON.parse(inputs.date);
      ...
      moment(dt).isValid() ? console.log('INPUTS:  Соответствует формату строки ISO 8601.') : console.log('INPUTS: Ошибка! НЕ соответствует формату строки ISO 8601.');
