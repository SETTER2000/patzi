module.exports = {
  ...
  fn: async function (inputs,exits) {
    ...
    let images = inputs.images ? inputs.images : title.images;
    let titleBackground = inputs.titleBackground ? inputs.titleBackground : title.titleBackground;
    let imagesNew = [];
    ...
    // Обновляем
    let updateTitle = await Title.updateOne({id: inputs.id})
      .set(updateObj);
    ...
    await sails.sockets.broadcast('title', 'update-title');
