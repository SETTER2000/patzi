module.exports = {
  ...
  exits: {
    success: {
      anyData: 'Вы подключились к комнате like и слушаете событие list-like'
    },
    notFound: {
  ...
  fn: async function (inputs, exits) {
    ...
    let module = await sails.helpers.listLike.with({
    ...
    await sails.sockets.broadcast('litter', 'list-like', module);
