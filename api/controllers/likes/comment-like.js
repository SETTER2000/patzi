module.exports = {
  ...
  friendlyName: 'Comment like',


  description: 'Добавляет like к комментарию.',
  ...
  inputs: {
    ...
    commentId: {
      type: 'string',
      example: '5d6e1e2b8a34f8057046c15e',
      required: true,
  ...
  fn: async function (inputs, exits) {
     ...
     */
    let like = await sails.helpers.oneCommentLike.with({
      id: newLike.id,
    ...
    await sails.sockets.broadcast('litter', 'comment-like', {likes: like});
