...
parasails.registerComponent('patziRowH3H2', {
  //  ╔═╗╦═╗╔═╗╔═╗╔═╗
  //  ╠═╝╠╦╝║ ║╠═╝╚═╗
  //  ╩  ╩╚═╚═╝╩  ╚═╝
  props: [
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-title text-center">
            <h3>{{objData.preferredLocale === 'ru' ? objData.h3.ru : objData.h3.en}}</h3>
            <h2><span>{{objData.preferredLocale === 'ru' ? objData.h2.ru : objData.h2.en}}</span></h2>
          </div>
        </div>
      </div>
`,
