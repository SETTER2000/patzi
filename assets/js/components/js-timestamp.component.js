 ...
 * Удобочитаемая, самообновляющаяся метка времени "timeago" с некоторыми особыми правилами:
   *
   * • В течение 24 часов отображается в формате «timeago».
   * • В течение месяца отображает месяц, день и время суток.
   * • В течение года отображаются только месяц и день.
   * • Старше / новее, отображает месяц и день за полный год.
 *
 * @type {Component}
 * -----------------------------------------------------------------------------
 */
