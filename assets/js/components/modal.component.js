 ...
 * > consequences.
 *
 * *> Будьте осторожны, добавляя другие обратные вызовы жизненного цикла Vue.js в этот файл!
   *> Используется плавное сочетание переходов Vue и модальной анимации при загрузке
   *> здесь работают, и очень хорошо проверены в практических приложениях. Но любой
   *> изменения в этом конкретном коктейле могут быть непредсказуемыми, с неприятными
   *> последствия.
 *
 * @type {Component}
 *
