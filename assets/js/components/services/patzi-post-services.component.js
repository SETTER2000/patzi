      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-service wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.0s">
            ...
            <p>{{objData.preferredLocale === 'ru' ? 'Модная, пародная стрижка. Мытьё. Чистка ушей, когтей, эпиляция. Использование профессиональной косметики.' : 'Fashionable, haircut. The washing up. Cleaning the ears, claws, hair removal. Use of professional cosmetics.'}}</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="single-service wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
